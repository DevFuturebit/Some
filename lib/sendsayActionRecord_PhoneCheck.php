...
class sendsayActionRecord_PhoneCheck extends sendsayAction
{
    public $sub_send_params = Array(
        "action" => "issue.send",
        "letter" => array("from.name" => "lensmaster", "draft.id" => "268"),
        "group" => "personal",
        "mute" => "1",
        "sendwhen" => "now");
    ...
    public function subscribeAction($data)
    {
        ...
        $this->sub_subscribe_params['obj']['a25']['q365'] = $data['checkcode'];
        $this->sub_subscribe_params['obj']['a25']['q586'] = date("Y-m-d H:i");
